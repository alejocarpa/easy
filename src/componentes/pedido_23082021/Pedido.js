...
function Pedido() {
    ...
    const [valor_recibido, setValor_recibido] = useState('');
                        ...
                        {pantalla === "Nuevo" || pantalla === "Editar" ?
                            <div>
                                ...
                                <div className="d-flex justify-content-end">
                                    ...
                                    <input type='text' name="valor_total_hidden" id="valor_total_hidden" className="form-control" value={valor_total}></input>
                                </div>
                                <div className="d-flex justify-content-end">

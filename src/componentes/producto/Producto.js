                ...
                <form className="row mt-3" onSubmit={enviarDatos}  >
                    ...
                    grupo_producto === "SI" ? 
                        <div className="col-md-3 p-2">
                            ...
                            <input className="form-control" type="text" list="datalistOptions" name="laboratorio" value={datos.laboratorio} placeholder="Buscar..." onChange={handleInputChange} />
                            <datalist id="datalistOptions">
                                {!laboratorios ? "Cargando..." : laboratorios.map((laboratorio, index) => {
                                    return <option key={index} value={laboratorio.gru_codigo+'-'+laboratorio.gru_nombre}></option>
                                })}
                            </datalist>
                        </div>
